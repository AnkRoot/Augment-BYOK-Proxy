...
fn default_history_summary_template_old() -> String {
  r#"
<supervisor>
...
fn default_history_summary_template_new() -> String {
  r#"
<supervisor>
...
pub struct HistorySummaryConfig {
  ...
  #[serde(default)]
  pub use_history_summary_new: bool,
  #[serde(default = "default_history_summary_template_old")]
  pub summary_node_request_message_template: String,
  #[serde(default = "default_history_summary_template_new")]
  pub summary_node_request_message_template_new: String,
  #[serde(default)]
...
impl Default for HistorySummaryConfig {
  fn default() -> Self {
    Self {
      ...
      use_history_summary_new: false,
      summary_node_request_message_template: default_history_summary_template_old(),
      summary_node_request_message_template_new: default_history_summary_template_new(),
...
impl HistorySummaryConfig {
  pub fn validate(&self, byok: &ByokConfig) -> anyhow::Result<()> {
    ...
    if self.summary_node_request_message_template.trim().is_empty()
      && self.summary_node_request_message_template_new.trim().is_empty()
    {
      anyhow::bail!("history_summary.summary_node_request_message_template 不能为空（old/new 至少一个）");
    }
